...
% -------------------------------------------
function h_fig1 = GSPCylindricalShell_t6(U1,GSP1,U2,GSP2,U3,GSP3,U4,GSP4)
...
ax.YAxis.MinorTickValues=-0.25:0.5:3.5;
leg=legend({'P1C1','P2C1','P3C1','P4C1'}, ...
    'interpreter','latex','FontSize',24,'box','off'); 
set(leg,'Position',[0.6,0.72,0.2,0.12]); 
