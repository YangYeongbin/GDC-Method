...
% -------------------------------------------
function h_fig1 = DrawSphericalShell(U1,F1,U2,F2,U3,F3,U4,F4,Horrigmoe_u,Horrigmoe_p)
...
ax.YAxis.MinorTickValues=5:10:60;
leg=legend({'P1C1','P2C1','P3C1','P4C1','ALM','Horrigmoe and Bergan'}, ...
    'interpreter','latex','FontSize',24,'box','off'); 
set(leg,'Position',[0.6,0.4,0.2,0.12]); 
