...
% -------------------------------------------
function h_fig1 = GSPSphericalShell(U1,GSP1,U2,GSP2,U3,GSP3,U4,GSP4)
...
hold on
plot([-100,300],[0,0],'Color',[0 0 0],'LineWidth',1.2);
