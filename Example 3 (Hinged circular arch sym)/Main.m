...
%--------------------------------------------------------------------
% arc-length method
arc = load('arc length.txt');
arc_u = arc(:,1); arc_p = arc(:,2);
% Uy vs. Fy
Displ_load = DrawDeepArch_sym(result{2}{2},result{2}{1},result{3}{2},result{3}{1},result{4}{2},result{4}{1},arc_u,arc_p);
% Uy vs. GSP
Displ_GSP  = GSPDeepArch_sym(result{2}{2},result{2}{3},result{3}{2},result{3}{3},result{4}{2},result{4}{3});
% Computational time
