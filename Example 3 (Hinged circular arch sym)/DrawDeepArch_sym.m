...
% -------------------------------------------
function h_fig1 = DrawDeepArch_sym(U1,F1,U2,F2,U3,F3,arc_u,arc_p)
...
hold on
text(65,-250,'Numerical divergence','Color',[1 0 0],'FontName','Times New Roman','FontSize',20)
plot([-100,100],[0,0],'Color',[0 0 0],'LineWidth',1.2);
plot([0,0],[-600,600],'Color',[0 0 0],'LineWidth',1.2);
plot([93,95],[-240,-90],'Color',[1 0 0],'LineWidth',1.2)
% parameter setting
axis([0,100,-300,300]);                                                      
...
set(leg,'Position',[0.6,0.78,0.2,0.12]);                               
